...
CREATE TABLE `tbl_device` (
                              ...
                              KEY `USER_NAME` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=25080 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=DYNAMIC COMMENT='Trạm sạc. Mỗi trạm sạc tương ứng 1 device ID (1 thiết bị gateway duy nhất)\r\n\r\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_role` VALUES
                           (1,'ADMIN','Quản trị viên. Có quyền tạo/sửa/xóa thiết bị trong nhóm',1,0,1,NULL,NULL,NULL,'Quyền quản trị'),
                           (2,'OPERATOR','Vận hành, giám sát. Không có quyền chỉnh sửa.',1,1,2,'2018-01-02 15:50:32',2,'2023-10-26 17:04:54','Quyền vận hành');
...
) ENGINE=InnoDB AUTO_INCREMENT=399 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci COMMENT='Mapping between user & group. One user can belong to many group';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_parameter` VALUES
                                ...
                                (8,'LICENSE','TcEzVFuXGEPGpt8CoFGFpVGp8q3vnPuy2Fm0EKwp7CS7dCtt2fwHQc8k2C53OUKntgP6UrbMSJnPDYo3QEArEZcceg51CUZjN+pxnIr4y/FYk6KEgt0Tj4rYp3m2lCIr+pb9rXSVAA4SDBOmhDv3Ae/6IX+hP3Z0','java.lang.String','2023-11-17 15:27:09','2023-12-06 10:25:13',2,2),
...
) ENGINE=InnoDB AUTO_INCREMENT=39 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_general_ci ROW_FORMAT=COMPACT COMMENT='Mapping between user and role. One user can has many roles. Many users may have the same role.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-12-06 21:40:40
